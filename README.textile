...
* *Timeoutable* should timeout Facebook sessions as well - configurable.
* *Ensure no module clashes* with Devise core modules is a design goal, but have only tested @Tracking@ and @Confirmable@ thoroughly so far for.
