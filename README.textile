...
Installs the required Javascripts...
...
* "authlogic_facebook_connect":http://github.com/kalasjocke/authlogic_facebook_connect by "Joakim Ekberg":http://github.com/kalasjocke

h2. TODO / Known Issues

* *Expired sessions* happens quite often right now. @before_facebook_connect@-hook fails. =/ Highest priority right now.
* *Depend on Devise master* instead of my own hacked version.
